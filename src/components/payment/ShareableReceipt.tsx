...
export function ShareableReceipt({
  ...
  const handleShareWhatsApp = async () => {
    const text = `Estou confirmado(a) no ${eventName}! ${eventDates} - ${eventLocation}`
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
        ...
        <button
          ...
          className="btn-secondary flex-1 flex items-center justify-center gap-2 bg-green-600/20 border-green-600/40 hover:bg-green-600/30"
        >
