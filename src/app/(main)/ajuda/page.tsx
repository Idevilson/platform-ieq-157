...
const FAQ: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Onde pago presencialmente (dinheiro)?', a: 'Na secretaria da Igreja. Consulte a organização para horários de atendimento.', whatsapp: 'https://wa.me/5594991888255' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Para pagar em dinheiro, preciso ir pessoalmente?', a: 'Sim — dirija-se à secretaria da Igreja, informe o nome do responsável e efetue o pagamento. Todos os participantes são confirmados na hora.', whatsapp: 'https://wa.me/5594991888255' },
      { q: 'As inscrições ficam reservadas até eu pagar?', a: 'Sim, ficam como "Pendente" sem prazo de cancelamento automático.' },
    ],
  },
]

function AccordionItem({ q, a, whatsapp }: FaqItem) {
  ...
  return (
    <div className="border-b border-gold/10 last:border-0">
      ...
      {open && (
        <div className="pb-4">
          <p className="text-sm text-text-secondary leading-relaxed whitespace-pre-line mb-3">{a}</p>
          {whatsapp && (
            <a
              href={whatsapp}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-[#25D366] border border-[#25D366]/30 bg-[#25D366]/10 hover:bg-[#25D366]/20 transition-colors no-underline"
            >
